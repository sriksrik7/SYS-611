...
class Tennis_Player:
  ...
  # Weightage constants
  ACE_WEIGHT = 10/100
  DOUBLE_FAULT_WEIGHT  = 5/100
  FIRST_SERVE_WEIGHT  = 9/100
  FIRST_SERVE_WON_WEIGHT  = 9/100
  SECOND_SERVE_WON_WEIGHT  = 7/100
  BREAK_POINT_SAVED_WEIGHT  = 7/100
  SERVICE_POINTS_WON_WEIGHT  = 6/100
  SERVICE_GAMES_WON_WEIGHT = 8/100
  ACE_AGAINST_WEIGHT  = 5/100
  FIRST_SERVE_RET_WON_WEIGHT  = 6/100
  SECOND_SERVE_RET_WON_WEIGHT  = 7/100
  BREAK_POINTS_WON_WEIGHT  = 6/100
